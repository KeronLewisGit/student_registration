        ...
        <form>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="student_class">Select Student Class:</label>
                    <select id="student_class" class="form-control">
                        <option selected>Select</option>
                        <?php
                        foreach ($records as $record) {
                        echo "<option>".$record['Form 1 Class']."</option>";
                        }
                        ?>
                    </select>
                </div>
                <div class="form-group col-md-6">
                    <label for="student_name">Select Student Name:</label>
                    <select id="student_name" class="form-control">
                        <option selected>Select</option>
                        <option>...</option>
                    </select>
                </div>
